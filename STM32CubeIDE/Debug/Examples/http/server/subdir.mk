...
C_SRCS += \
D:/Master/W5300-TOE-C-main/W5300-TOE-C-main/Examples/http/server/w5x00_http_server.c 

OBJS += \
./Examples/http/server/w5x00_http_server.o 

C_DEPS += \
./Examples/http/server/w5x00_http_server.d 


# Each subdirectory must supply rules for building sources it contributes
Examples/http/server/w5x00_http_server.o: D:/Master/W5300-TOE-C-main/W5300-TOE-C-main/Examples/http/server/w5x00_http_server.c Examples/http/server/subdir.mk
...
clean: clean-Examples-2f-http-2f-server

clean-Examples-2f-http-2f-server:
	-$(RM) ./Examples/http/server/w5x00_http_server.cyclo ./Examples/http/server/w5x00_http_server.d ./Examples/http/server/w5x00_http_server.o ./Examples/http/server/w5x00_http_server.su

.PHONY: clean-Examples-2f-http-2f-server
